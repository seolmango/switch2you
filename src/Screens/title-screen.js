...
titleScreen.draw = function (Background_ctx, UI_ctx, Screen) {
    ...
    if(checkTouch(Screen.userMouse.x, Screen.userMouse.y, 960, 540, 300, 100)) {
        ...
        drawText(UI_ctx,960, 540, 50, 0, Color_list.button_gray_3_hex, undefined, undefined, "start game", "center", 'GmarketSansMedium');
    } else {
    ...
    if(checkTouch(Screen.userMouse.x, Screen.userMouse.y, 960, 700, 300, 100)) {
        ...
        drawText(UI_ctx,960, 700, 50, 0, Color_list.button_gray_3_hex, undefined, undefined, "setting", "center", 'GmarketSansMedium');
    } else {
